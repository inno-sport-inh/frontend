    ...
    >
      ...
      <div className="innohassle-card p-4 sm:p-6">
        <div className="text-center">
          <h2 className="text-xl sm:text-2xl font-semibold text-contrast mb-4">
            Your Sport Progress
          </h2>
          ...
          <div className="max-w-md mx-auto">
            ...
            <div className="mt-2 text-xs text-inactive">
              {progressPercentage.toFixed(1)}% completed
            </div>
            <div className="mt-1 text-xs text-brand-violet font-medium">
              🎯 You are better than {studentPercentile}% of students
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between gap-2">
        <button 
          ...
          className="innohassle-button-secondary px-3 sm:px-4 py-2 flex items-center space-x-1 sm:space-x-2 flex-shrink-0"
        >
          <ChevronLeft size={16} />
                      ...
                      <div
                        ...
                        className={`p-3 sm:p-4 rounded-xl border-2 transition-all duration-200 cursor-pointer ${
                          activityStatus === 'booked' 
                            ? 'border-brand-violet bg-brand-violet/10 shadow-lg shadow-brand-violet/20' 
                            : activity.isPast
                            ? 'activity-past'
                            ...
                            : 'bg-floating border-secondary hover:border-brand-violet/60 hover:bg-brand-violet/5 hover:shadow-md'
                        }`}
                                  ...
                                  {activityStatus === 'free' ? (
                                    ...
                                    <button
                                      onClick={(e) => {
                                        ...
                                        setWeekActivities(prev => prev.map(act =>
                                          act.id === activity.id
                                            ? { 
                                                ...act, 
          ...
          <div className="bg-pagebg innohassle-card max-w-md w-full max-h-[90vh] overflow-y-auto relative z-10">
            <div className="p-6">
              ...
              <div className="flex items-start justify-between mb-6">
                ...
                <button
                  onClick={closeModal}
                  className="text-inactive hover:text-contrast transition-colors text-2xl font-light"
                >
                  ×
                </button>
              </div>
